...
#include "TopDownBulletHell/Components/HealthComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	TOPDOWNBULLETHELL_API UClass* Z_Construct_UClass_UHealthComponent_NoRegister();
	TOPDOWNBULLETHELL_API UClass* Z_Construct_UClass_UHealthComponent();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHealthComponent_TakeDamage_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//Method for taking damage\n" },
		{ "ModuleRelativePath", "Components/HealthComponent.h" },
		{ "ToolTip", "Method for taking damage" },
	};
#endif
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultMaxHealth_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DefaultMaxHealth;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthComponent_TakeDamage, "TakeDamage" }, // 3080470624
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHealthComponent_Statics::NewProp_DefaultMaxHealth_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Components" },
		{ "Comment", "//Base Max Health of the actor editable\n" },
		{ "ModuleRelativePath", "Components/HealthComponent.h" },
		{ "ToolTip", "Base Max Health of the actor editable" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHealthComponent_Statics::NewProp_DefaultMaxHealth = { "DefaultMaxHealth", nullptr, (EPropertyFlags)0x0040000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHealthComponent, DefaultMaxHealth), METADATA_PARAMS(Z_Construct_UClass_UHealthComponent_Statics::NewProp_DefaultMaxHealth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHealthComponent_Statics::NewProp_DefaultMaxHealth_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHealthComponent_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHealthComponent_Statics::NewProp_DefaultMaxHealth,
	};
	...
	IMPLEMENT_CLASS(UHealthComponent, 4021493961);
	template<> TOPDOWNBULLETHELL_API UClass* StaticClass<UHealthComponent>()
	{
		return UHealthComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UHealthComponent(Z_Construct_UClass_UHealthComponent, &UHealthComponent::StaticClass, TEXT("/Script/TopDownBulletHell"), TEXT("UHealthComponent"), false, nullptr, nullptr, nullptr);
